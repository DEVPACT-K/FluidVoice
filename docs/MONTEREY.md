...
- **Notch overlay on 2015 Air**: Fixed — 2015 Air has no notch; `NotchOverlayManager` now falls back to bottom pill on Monterey Intel (tested via `MontereyOverlayTests`).
